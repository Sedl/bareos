...
Normally, you will install the Windows version of Bareos from the binaries. The **winbareos** binary packages are provided under https://download.bareos.org/bareos/release/21/windows/. Additionally, there are `OPSI <https://www.opsi.org>`_ packages available under https://download.bareos.org/bareos/release/21/windows/opsi/.
