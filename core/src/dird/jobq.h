...
struct jobq_t {
  ...
  std::deque<jobq_item_t*> waiting_jobs; /* list of jobs waiting */
  std::deque<jobq_item_t*> running_jobs; /* jobs running */
  std::deque<jobq_item_t*> ready_jobs;   /* jobs ready to run */
